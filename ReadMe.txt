...
4. Включите «Основной браузер» или нажмите Ctrl+M.
...
- Пауза: Ctrl+Q.
- Стоп: P.
- Полный экран основного браузера: Ctrl+F.
- Назначение основного браузера: Ctrl+M.

Горячие клавиши работают при английской и русской раскладке.
